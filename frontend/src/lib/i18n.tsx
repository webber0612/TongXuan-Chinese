...
const messages: Record<DisplayLanguage, Record<string, string>> = {
  ...
  ja: {
    ...
    curriculumTitle: "学習ロードマップ", curriculumIntro: "公式教材に沿って段階的に学びます。", courseZeroTitle: "発音入門ラボ", courseZeroDescription: "注音・ピンインと声調の基礎を学びます。", courseZeroFullIntro: "公式教材の順序に沿って、発音の土台を築きます。", courseZeroBoundary: "学習プレビュー画面です。", courseZeroPracticeTitle: "今日の2つのミッション", courseZeroListenTask: "中国語の音を聞く", courseZeroMatchTask: "注音とピンインを合わせる", backToMap: "マップへ戻る", previous: "前へ", nextStep: "次へ", startFirstLesson: "第1課へ進む", coursePreparing: "準備中", officialCourseTitle: "公式カリキュラム", officialCourseNote: "入門冊 → 基礎冊 → 第1冊の体系的コースです。", pathConfirmed: "ルート確認済", contentImportPending: "教材準備中", firstLessonTitle: "第1課：こんにちは", firstLessonIntro: "公式教材の最初のレッスンです。", lessonImportPending: "レッスン準備中", sourceRecord: "出典記録", openOfficialSource: "公式ページを開く", officialObjectivesLabel: "公式の学習目標", practiceTargetsLabel: "アプリの練習目標", objectiveSourceLabel: "教師用ガイドの出典", sourceRecordNote: "ライセンスと教材登録完了後に利用可能になります。", lessonPreparing: "準備中", curriculumChild: "学習者", refreshCurriculum: "更新", completed: "修了", inProgress: "学習中", notStarted: "未着手", asOf: "データ時点",
