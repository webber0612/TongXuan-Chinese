...
const messages: Record<DisplayLanguage, Record<string, string>> = {
  "zh-Hant": {
    ...
    legacyRouteTitle: "此舊路徑已停用", legacyRouteDescription: "此路徑不屬於正式 TongXuan Web App，請返回官方首頁。",
    practiceTitle: "一起練習中文", practiceHint: "選一個小活動開始，完成後就能看到自己的進步。", settingsTitle: "讓 App 更適合你",
    curriculumTitle: "中文學習地圖", curriculumIntro: "沿著官方教材，一課一課完成你的中文旅程。", courseZeroTitle: "聲音工具入門", courseZeroDescription: "依官方入門冊，先注音再銜接拼音與聲調，接著進入第一課。", courseZeroFullIntro: "依官方入門冊的順序，先建立注音，再用相同內容銜接漢語拼音，最後進入第一冊第一課。", courseZeroBoundary: "這是學習導覽，不冒充官方課文；正式內容會在來源登錄後匯入。", courseZeroPracticeTitle: "今天先練這兩件事", courseZeroListenTask: "聽一聽中文聲音", courseZeroMatchTask: "把注音和拼音配起來", backToMap: "回到學習地圖", previous: "上一個", nextStep: "下一個", startFirstLesson: "進入第一課", coursePreparing: "準備中", officialCourseTitle: "官方教材路線", officialCourseNote: "課程順序固定來自官方教材：入門冊 → 基礎冊 → 第一冊；精確課文匯入前會先完成來源與授權登錄。", pathConfirmed: "路線已確認", contentImportPending: "內容待匯入", firstLessonTitle: "第一課：你好", firstLessonIntro: "這是官方課程的第一個課文入口。完成入門冊與基礎冊後，再開始正式課文。", lessonImportPending: "課文內容尚未匯入，先保留官方來源與課程位置。", sourceRecord: "來源紀錄", openOfficialSource: "開啟官方教材頁", officialObjectivesLabel: "教師手冊目標摘要（本站改寫）", practiceTargetsLabel: "本站練習目標", objectiveSourceLabel: "教師手冊來源", sourceRecordNote: "只有完成內容來源、授權與版本登錄後，課文才會進入可練習狀態。", lessonPreparing: "課文準備中", curriculumChild: "學習者", refreshCurriculum: "更新進度", completed: "完成", inProgress: "進行中", notStarted: "未開始", asOf: "資料截至",
  ...
  en: {
    ...
    legacyRouteTitle: "This route is unavailable", legacyRouteDescription: "This route is not part of the official TongXuan Web App. Return to the official home.",
  ...
  ja: {
    ...
    legacyRouteTitle: "この旧ルートは利用できません", legacyRouteDescription: "このルートは公式 TongXuan Web App にありません。公式ホームに戻ってください。",
    practiceTitle: "中国語を練習しよう", practiceHint: "好きなレッスンを選んで楽しく学びましょう。", settingsTitle: "アプリ設定",
    curriculumTitle: "学習ロードマップ", curriculumIntro: "公式教材に沿って段階的に学びます。", courseZeroTitle: "発音入門ラボ", courseZeroDescription: "注音・ピンインと声調の基礎を学びます。", courseZeroFullIntro: "公式教材の順序に沿って、発音の土台を築きます。", courseZeroBoundary: "これは学習ガイドです。公式教材の本文ではありません。正式な教材は出典確認後に追加されます。", courseZeroPracticeTitle: "今日の2つのミッション", courseZeroListenTask: "中国語の音を聞く", courseZeroMatchTask: "注音とピンインを合わせる", backToMap: "マップへ戻る", previous: "前へ", nextStep: "次へ", startFirstLesson: "第1課へ進む", coursePreparing: "準備中", officialCourseTitle: "公式カリキュラム", officialCourseNote: "入門冊 → 基礎冊 → 第1冊の体系的コースです。", pathConfirmed: "ルート確認済", contentImportPending: "教材準備中", firstLessonTitle: "第1課：こんにちは", firstLessonIntro: "公式教材の最初のレッスンです。", lessonImportPending: "レッスン準備中", sourceRecord: "出典記録", openOfficialSource: "公式ページを開く", officialObjectivesLabel: "教師用ガイドの要約（TongXuan作成）", practiceTargetsLabel: "アプリの練習目標", objectiveSourceLabel: "教師用ガイドの出典", sourceRecordNote: "ライセンスと教材登録完了後に利用可能になります。", lessonPreparing: "準備中", curriculumChild: "学習者", refreshCurriculum: "更新", completed: "修了", inProgress: "学習中", notStarted: "未着手", asOf: "データ時点",
  ...
  es: {
    ...
    legacyRouteTitle: "Esta ruta no está disponible", legacyRouteDescription: "Esta ruta no forma parte de TongXuan Web App. Vuelve al inicio oficial.",
