...
def curriculum_payload():
    ...
    return {"levels": [{"id": "tutor-level", "title": "Tutor Level", "sequence": 1, **source, "units": [{"id": "tutor-unit", "title": "Tutor Unit", "sequence": 1, **source, "items": [{"id": "tutor-item", "item_type": "sentence", "content": "學而時習之", "sequence": 1, **source}]}]}]}
